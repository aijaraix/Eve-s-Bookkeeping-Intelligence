...
function project(ws: any, engagementId: string, docs: any[], facts: any[], states: any[], packages: any[], findings: any[], jobs: any[]): any {
  ...
  return {
    ...
    documents: docs.map(d => ({ ...d, documentId: d.id, filename: d.originalName || d.filename || d.name || null, filesize: d.size ?? null, mimeType: d.mimeType || d.type || null, sha256: d.sha256 || null, classification: d.category || null, uploadedAt: d.createdAt || d.uploadedAt || null, pagesCount: d.pageCount ?? d.pagesCount ?? null })),
