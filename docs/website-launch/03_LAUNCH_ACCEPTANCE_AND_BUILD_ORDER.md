...
2. read `docs/customer-platform/` before wiring pricing/checkout if that directory exists in the current remote state,
3. use the owner's approved Canva boards as visual references only,
