        ...
        <div className="bg-gradient-to-r from-blue-700 to-indigo-700 px-6 py-4 text-white flex items-center justify-between">
          <div>
            <div className="text-[11px] font-mono uppercase text-blue-200 font-semibold tracking-wider">
              {fact.statementType.replace('_', ' ')} Provenance Lineage
            </div>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs bg-slate-50 p-4 rounded-xl border border-slate-200">
            ...
            <div>
              ...
              <span className="text-lg font-bold font-mono text-slate-800">"{fact.rawString}"</span>
            </div>
            <div>
              <span className="text-slate-500 block text-[11px]">Scale Multiplier Source</span>
              <span className="font-mono text-slate-700 font-semibold">{fact.scaleSource || 'Table Header Scale (Millions)'}</span>
            </div>
            <div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between text-[11px] font-mono text-slate-500 pt-1">
              ...
              <span>Page {fact.pageNumber}, Line {fact.provenance.lineNumber || 14}</span>
            </div>
          </div>

          {/* Section details */}
          <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 text-xs text-slate-600 space-y-1 font-mono">
            <div><strong>Statement Section:</strong> {fact.provenance.section}</div>
